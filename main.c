...
/******************************************************************************/
/* Author:   Mikel Skreen
 * Modified By: Maya Kalapatapu (September 27th, 2024)                                                */
...
void PrintSquares() {
   ...
   xil_printf("Pmod KYPD demo started. Press any key on the Keypad to print its square.\r\n");
   while (1) {
